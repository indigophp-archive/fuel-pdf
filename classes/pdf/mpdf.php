...
{
	protected function _pdf($mode = '', $format = 'A4', $default_font_size = '', $default_font = '', $margin_left = 15, $margin_right = 15, $margin_top = 16, $margin_bottom = 16, $margin_header = 9, $margin_footer = 9, $orientation = 'P')
	{
